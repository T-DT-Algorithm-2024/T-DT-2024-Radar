...
class Memory : public BaseMemory {
 public:
  ...
  inline size_t unified_size() const { return unified_bytes_ / sizeof(_DT); }

  virtual inline _DT *gpu() const { return (_DT *)gpu_; }
  virtual inline _DT *cpu() const { return (_DT *)cpu_; }
  virtual inline _DT *unified() const { return (_DT *)unified_; }
};
